...
namespace StateManagment.Models
{
    ...
    {
        Task<TaskOutcome> ChangeStatusTo<T>(string entityId, EntityState entityState, Feedback[]? feedbacks = null, OrchestrationData[]? orchestrationData = null) where T : IEntity;
