...
namespace StateManagment.Models
{
    ...
    {
        Task<TaskOutcome> ChangeStatusTo<T>(string entityId, string customerId, EntityState entityState, Feedback[]? feedbacks = null, OrchestrationData[]? orchestrationData = null, string? legalEntityId = null) where T : IEntity;
